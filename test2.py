...
convolutional_neural_network = DeepFingerPrintingNeuralNetwork(input=(5,1), N=NUMBER_OF_PAGES)
...
convolutional_neural_network.compile(loss=identity_loss, optimizer=opt)
convolutional_neural_network.fit(X_train, y_train, batch_size=100,shuffle=True, epochs=3, verbose=1, validation_data=(X_valid, y_valid))
X_valid = X_valid.astype('float32')
X_valid = X_valid[:, :,np.newaxis]
result = convolutional_neural_network.predict(X_valid, verbose=2)
